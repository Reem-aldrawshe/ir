...
def evaluate_tfidf(results_path, k=10):
    # تحميل qrels من مجموعة antique (non-offensive)
...
if __name__ == "__main__":
    import sys
    if len(sys.argv) < 2:
        print("Usage: python evaluate_tfidf_antique.py <results_json_path>")
    else:
        results_path = sys.argv[1]
        results = evaluate_tfidf(results_path)
        print("📈 نتائج التقييم:")
